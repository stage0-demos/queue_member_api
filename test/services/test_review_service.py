...
class TestReviewService(unittest.TestCase):
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_create_review_success(self, mock_get_mongo, mock_get_config):
        """Test successful creation of a review document."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        ...
        self.assertEqual(call_args[0][0], "Review")
        created_data = call_args[0][1]
        self.assertIn("created", created_data)
        self.assertIn("saved", created_data)
        self.assertEqual(created_data["name"], "test-review")

    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_create_review_removes_id(self, mock_get_mongo, mock_get_config):
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_first_batch(self, mock_get_mongo, mock_get_config):
        ...
        mock_cursor.__iter__ = lambda self: iter(
            [
                {"_id": ObjectId("507f1f77bcf86cd799439011"), "name": "review1"},
                {"_id": ObjectId("507f1f77bcf86cd799439012"), "name": "review2"},
            ]
        )
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_invalid_limit_too_small(self, mock_get_mongo, mock_get_config):
        """Test get_reviews raises HTTPBadRequest for limit < 1."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        mock_mongo = MagicMock()
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_invalid_limit_too_large(self, mock_get_mongo, mock_get_config):
        """Test get_reviews raises HTTPBadRequest for limit > 100."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        mock_mongo = MagicMock()
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_invalid_sort_by(self, mock_get_mongo, mock_get_config):
        """Test get_reviews raises HTTPBadRequest for invalid sort_by."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        mock_mongo = MagicMock()
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_invalid_order(self, mock_get_mongo, mock_get_config):
        """Test get_reviews raises HTTPBadRequest for invalid order."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        mock_mongo = MagicMock()
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_invalid_after_id(self, mock_get_mongo, mock_get_config):
        """Test get_reviews raises HTTPBadRequest for invalid after_id."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        mock_mongo = MagicMock()
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_review_success(self, mock_get_mongo, mock_get_config):
        """Test successful retrieval of a specific review document."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        ...
        mock_mongo.get_document.assert_called_once_with("Review", "123")

    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_review_not_found(self, mock_get_mongo, mock_get_config):
        """Test get_review raises HTTPNotFound when document not found."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_update_review_success(self, mock_get_mongo, mock_get_config):
        """Test successful update of a review document."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
        ...
        data = {"name": "updated-review", "description": "Updated"}
        ...
        self.assertEqual(updated["name"], "updated-review")
        ...
        self.assertEqual(set_data["name"], "updated-review")

    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_update_review_prevent_restricted_fields(
        self, mock_get_mongo, mock_get_config
    ):
        """Test update_review raises HTTPForbidden for restricted fields."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_update_review_not_found(self, mock_get_mongo, mock_get_config):
        """Test update_review raises HTTPNotFound when document not found."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_update_review_uses_breadcrumb_directly(
        self, mock_get_mongo, mock_get_config
    ):
        """Test update_review uses breadcrumb directly for saved field."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_create_review_handles_exception(
        self, mock_get_mongo, mock_get_config
    ):
        """Test create_review handles database exceptions."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_reviews_handles_exception(
        self, mock_get_mongo, mock_get_config
    ):
        """Test get_reviews handles database exceptions."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_get_review_handles_exception(
        self, mock_get_mongo, mock_get_config
    ):
        """Test get_review handles database exceptions."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
    ...
    @patch("src.services.review_service.Config.get_instance")
    @patch("src.services.review_service.MongoIO.get_instance")
    def test_update_review_handles_exception(
        self, mock_get_mongo, mock_get_config
    ):
        """Test update_review handles database exceptions."""
        mock_config = MagicMock()
        mock_config.REVIEW_COLLECTION_NAME = "Review"
        mock_get_config.return_value = mock_config
